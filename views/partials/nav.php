...
{
  return $_SERVER['REQUEST_URI'] ===  $theURL ? 'bg-gray-900 text-white' :  'text-gray-300';
}; ?>
      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="index.php" class=" <?= isURL('/php-course-project/index.php') ?> rounded-md px-3 py-2 text-sm font-medium " aria-current="page">Home</a>
            <a href="about.php" class="<?= isURL('/php-course-project/about.php') ?> rounded-md px-3 py-2 text-sm font-medium  hover:bg-gray-700 hover:text-white">About</a>
            <a href="contact.php" class="<?= isURL('/php-course-project/contact.php') ?> rounded-md px-3 py-2 text-sm font-medium  hover:bg-gray-700 hover:text-white">Contact</a>
          </div>
        </div>
      </div>
      <div class="hidden md:block">
